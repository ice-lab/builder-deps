...
const { getOptions } = require('@builder/pack/deps/loader-utils');
const { validate: validateOptions } = require('@builder/pack/deps/schema-utils3');
const { SourceMapConsumer, SourceNode } = require('@builder/pack/deps/source-map');
const {
